...
\swp{maybe this is where it might be better to say "speed provides the better framing ..."?}
...
\swp{I feel like there's too much ``something, ...'' phrasing. How about the following?} 
\swp{
...
\swp{``conditions characteristic of a naive population'' doesn't really make sense...}
...
\swp{The last two/three sentences feel repetitive.}
...
There has been a great deal on discussion of the importance of pre-symptomatic transmission of COVID-19 \cite{ferretti2020quantifying, he2020temporal, hellewell2020feasibility}. 
...
More early transmission, for a given value of \swp{observed} \rr, means {shorter generation intervals and therefore} less transmission per individual --- that is, a lower value of \RR. Thus, although earlier transmission could make intervention less effective, it also means that less intervention may be necessary. For interventions like lockdowns, which are generally assumed \swp{to} affect everyone roughly equally, the strength-based perspective thus gives a clear (and somewhat surprising) answer: more early transmission means we will conclude that non-targeted interventions are \emph{more} effective.
...
Thinking explicitly about the two perspectives can also reduce confusion. Because of the dominance of the strength paradigm, researchers often explore different scenarios while holding \RR\ fixed. Fixed \RR\ is in fact a good default assumption for many endemic diseases. For invading diseases, however, \rr\ is likely to be better constrained by data than \RR. In this case, comparing scenarios while holding \RR\ fixed creates a bias that makes scenarios with faster transmission at the individual level \swp{(i.e., higher proportion of early transmission)} look relatively more dangerous (since these scenarios will have \rr\ faster than the observed value) \citep{eaton2014proportion, powers2014impact, park2019practical}. \swp{I think we can remove the parenthesis in the last sentence}
...
\swp{How is this? Don't want to overwhelm with citations. Seems good enough for me.}
