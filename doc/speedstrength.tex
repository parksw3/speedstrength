...
relying on epidemic speed can be sometimes more effective in characterizing the course of an epidemic and evoluating intervention strategies.
In particular, the exponential growth rate can be directly measured from incidence data even early in an epidemic \citep{chowell2003sars, mills2004transmissibility, nishiura2009transmission, nishiura2010pros, ma2014estimating}, whereas the basic reproduction number can be difficult to estimate \citep{weitz2015modeling};
in these scenarios, intervention strategies should seek to reduce the epidemic speed.
The West African Ebola outbreak in 2014 provides a key example for this perspective: 
many researchers tried to estimate the basic reproduction number but the major intervention strategies involved slowing down the epidemic by identifying infected individuals and isolating them \citep{pandey2014strategies}.
