...
\jd{We should work on visual implication of quantitative effects: does strength work on a log scale? If not, try at least a scale that goes down to zero.}
A. The effectiveness of test-and-treat intervention is assumed to increase super-exponentially at first, and then saturate. The dashed line shows the corresponding effective strength of the intervention (from \eqref{strengthMean}) \jd{For what value of early transmission?}.
...
The dashed line shows the corresponding effective speed of the intervention (from \eqref{speedMean}) \jd{For what value of early transmission?}.
